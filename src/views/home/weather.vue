<template>
    <el-card class="home-weather"
             v-loading="loading"
             :body-style="{display: 'flex'}">
        <div class="home-weather-header"
             slot="header">
            <span class="home-weather-currentTime">
                <svg-icon iconClass="icon-time" />
                {{currentTime}}
            </span>
            <span class="home-weather-region">
                <svg-icon iconClass="icon-weizhi" />
                {{city}}，{{district}}
            </span>
        </div>
        <div class="home-weather-left">
            <svg-icon class="home-weather-icon"
                      :iconClass="data.icon" />
        </div>
        <div class="home-weather-right">
            <div class="home-weather-weatherInfo">
                <span class="home-weather-temperature">
                    {{data.temperature}}
                    <i class="home-weather-temperature-unit">&#8451;</i>
                </span>
                <span class="home-weather-weather">{{data.weather}}</span>
                <span class="home-weather-humidity">
                    <svg-icon iconClass="icon-shidu" />
                    湿度 {{data.humidity}} %
                </span>
            </div>
            <span class="home-weather-info">
                <i>
            ...
            <span class="home-weather-reporttime">
                <svg-icon iconClass="icon-time" />
